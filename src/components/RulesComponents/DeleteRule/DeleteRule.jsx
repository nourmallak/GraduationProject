...
import styles from '../DeleteRule/DeleteRule.module.css';

export default function DeleteRule({ show, onHide, rule, onSuccess }) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_API}/Rule/Delete-Rule/${rule.id}`,
                {
                    headers: {
