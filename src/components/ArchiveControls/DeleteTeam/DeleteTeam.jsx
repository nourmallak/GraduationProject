...
import styles from '../DeleteTeam/DeleteTeam.module.css';

export default function DeleteTeam({ show, onHide, competitionId, team, onSuccess }) {
    ...
    const handleDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_API}/Teams/Competition/${competitionId}/Remove-Team-From-Competition/${team.id}`,
                {
                    headers: {
            ...
            toast.error(error.response?.data || "Failed to delete Team", {
                position: "bottom-right",
                autoClose: 5000,
                transition: Bounce,
            ...
            {loading ?
                ...
                <>
                    <div className={`modal-header ${styles.modalHeader}`}>
                        <h5 className={`modal-title ${styles.modalTitle}`}>Delete Team</h5>
                        <button
                            type="button"
