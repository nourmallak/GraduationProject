...
export default function DeleteLocation({ show, onHide, locationId, onSuccess }) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_API}/Location/locations/${locationId}`,
                {
                    headers: {
            ...
            {loading ?
                ...
                <>
                    ...
                    <div className={`modal-header ${styles.modalHeader}`}>
                        <h5 className={`modal-title ${styles.modalTitle}`}>Delete Location</h5>
                        <button
                            type="button"
