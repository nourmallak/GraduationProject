...
import "./AddImagesAbout.css";
import { useParams, useNavigate } from "react-router-dom";
import Swal from "sweetalert2";

export default function AddImagesAbout() {
  ...
  text: "The images have been uploaded successfully. You will be redirected to the university page.",
  icon: "success",
